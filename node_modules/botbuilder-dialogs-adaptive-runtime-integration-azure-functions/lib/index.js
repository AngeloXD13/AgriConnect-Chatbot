    ...
    return {
        messageTrigger: (context, req) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const adapterSettings = (_a = configuration.type(['runtimeSettings', 'adapters'], z.array(z.object({
                    name: z.string(),
                ...
                yield resolvedAdapter.process({
                    headers: req.headers,
                    body: req.body,
                    method: (_b = req.method) !== null && _b !== void 0 ? _b : undefined,
                }, res, (turnContext) => __awaiter(this, void 0, void 0, function* () {
        ...
        staticTrigger: (context) => __awaiter(this, void 0, void 0, function* () {
            ...
            const contentType = (_c = extensionContentTypes[path_1.default.extname(filePath)]) !== null && _c !== void 0 ? _c : mime_1.default.getType(filePath);
            if (!contentType) {
                return res.status(404).end();
            }
            try {
